...
|---|---|---|---|---|
| 1 | Bootcamp | Slice, print, measure; first code-CAD | [clearance-test](family/clearance-test.scad) → find our magic gap number; [name-keychain](matt/name-keychain.scad) → first edit-a-line design | Everyone |
| 2 | Remix week | Make downloaded models *yours* | [remix-pedestal](family/remix-pedestal.scad) → `import()` any STL onto your own base with your own title | Everyone |
...
- **Tolerances & moving parts** → clearance-test → flexi-snake → gyro-fidget → ball joints
...
- **Advanced printer tricks** → height-range color (zoning map), lithophane, pause-at-height magnets
