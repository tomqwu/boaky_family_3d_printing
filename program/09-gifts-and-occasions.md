# The Gift Machine 🎁 — birthdays, holidays, and "just because"

A 3D printer turns you into the person whose gifts nobody forgets. This is the
...
*I made this for you specifically*. The personalization IS the gift. Everything
below leans on that.

## The personalization toolbox (our own projects, re-aimed)
...
**For friends (Matt's dept):** fidget in their colors → keychain with their
gamer tag → flexi animal of their favorite creature → capsule toy in a printed
capsule (BONBON style) → penalty-shootout mini game for a soccer friend.

**For friends (Peter's dept):** their street as a map tile → skyline with their
birth-year seed → a "landmark" building named after them with a one-paragraph
fake history (funnier than it sounds).

**For Mom:** lithophane night-light of a family photo (top of the list —
...
large-text keychains (genuinely useful) → a photo frame with magnets.

**For teachers (September!):** name desk plaque → whiteboard-marker holder →
class-subject themed pencil cup (the map tile of the school's street for
a geography teacher — legendary).

## The occasion calendar

| When | Occasion | Start printing | Go-to gift |
|---|---|---|---|
| ___ | Mom's birthday | 1 week before | Lithophane lamp |
| ___ | Dad's birthday | 1 week before | Measured desk organizer |
| ___ | Peter's birthday | — | (Matt designs something. Secret.) |
...
| May/Jun | Mother's/Father's Day | 1 week before | See Mom/Dad lists |

Fill in the blanks — then the printer never misses a birthday again.
...
## Brainstorm seeds (when you're staring at a blank plate)

1. What do they **lose** all the time? Print it a home. (keys → hook, remote → caddy)
2. What do they **love** that fits on a shelf? Make the miniature.
3. What photo would they want to **glow**? Lithophane it.
4. What **place** matters to them? Map it, terrain it, skyline it.
5. What do they **fidget** with in meetings? Upgrade it.
6. What's their **team/club/fandom**? Colors + crest + keychain.
7. What would make them **laugh**? A trophy for something ridiculous they're proud of.
