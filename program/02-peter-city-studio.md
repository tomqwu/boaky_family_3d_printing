# Peter's City Studio 🏙️

Your 8-week track: from printing cities to designing your own — ending with an original city district you designed in real CAD.
...
You already printed an NYC skyline. That makes you a city *printer*. This summer you become a city *designer*. The arc:
...
Camp rhythm all summer: Mon/Wed/Fri 60–90 min sessions, Sat big build (2–3 hrs), Sunday show-and-tell. Long prints run between sessions — Dad approves anything overnight.

---

## Week-by-week plan

### Week 1 (Jul 6–12) — Bootcamp: know your machine
**Goal:** Own Bambu Studio, and make your first tiny original thing.
...
- **Stretch:** Recreate a real NYC building at 1:2500 from its published height. (Math check: Empire State ≈ 443 m with antenna → about 177 mm at 1:2500.)
...
- **Skills:** Sketches, constraints, extrude/dimension, parametric variables ("change one number, every tile rescales"), PETG print settings.
- **Stretch:** Parametric building generator — one Fusion model where height and floor count are user parameters; generate 5 variants.
...
**Goal:** Design and start printing your original city district (full spec at the bottom).

- **Project:** Finalize the district plan on paper (zoning map, street grid, transit line), model the remaining buildings in Fusion 360, slice all plates, and start the multi-day print queue. Saturday = big build day; overnight plates need Dad's sign-off.
- **Skills:** Multi-plate project management, print-farm thinking (what prints in parallel), assembly design, keeping a build log.
- **Stretch:** One landmark building with an interior color surprise or a lit-from-within effect — see the [New York City — Illuminated 3D Model](https://makerworld.com/en/models/2803782-new-york-city-illuminated-3d-model) for how LED-ready city models are structured.

### Week 8 (Aug 24–30) — Finish + Showcase
**Goal:** Complete, assemble, present, publish.

- **Project 1:** Final plates, cleanup, magnet assembly, name your district, and build the showcase presentation: the "before" data print vs. your "after" design, plus your zoning map.
- **Project 2:** Publish your best original work to MakerWorld from Dad's account ([04-contests-and-community.md](04-contests-and-community.md)) — good photos, honest print settings, credit every system you built on.
- **Skills:** Presenting a design (the family design review — what real planners call public participation), publishing etiquette, retro: what would v2 fix?
- **Stretch:** Write the one-page "planning document" for your district — the story a real planning office would attach.

---

## Real city data toolbox
...
You're 13, which means you skip the kiddie pool fast and land in real CAD by week 5.

**Weeks 1–4: Tinkercad** (free, browser)
- Start: [official skyline project](https://www.tinkercad.com/projects/3D-Print-Your-Own-City-Skyline), [tinkercad.com/learn](https://www.tinkercad.com/learn), and the [architecture area](https://www.tinkercad.com/teachers/architecture).
- Deep library: [HL ModTech](https://hlmodtech.com/tinkercad) — 4,500+ middle-school-friendly videos. Also the [Instructables: How to Make a City in Tinkercad](https://www.instructables.com/How-to-Make-a-City-in-Tinkercad-1/) and a full [mini-city lesson at SCOPES-DF](https://www.scopesdf.org/scopesdf_lesson/3d-print-a-mini-city/).
- City projects here: GreebleCity-compatible tile, MINI-CITY-footprint building, 1:2500 NYC landmark, color-zoned building via [OBJ export to Bambu Studio](https://forum.bambulab.com/t/multi-color-from-tinkercad/26198).
- **Parametric detour (weeks 3–4):** [Tinkercad Codeblocks](https://www.tinkercad.com/blog/official-guide-to-tinkercad-codeblocks) — code a building module with height/width variables, loop it into a street grid. If you love the code side, [BlocksCAD](https://www.blockscad3d.com/educators) is the branch path.

**Weeks 5–8: Fusion 360 Personal Use** (free, [license terms](https://www.autodesk.com/products/fusion-360/personal))
- Cross over with the [Tinkercad → Fusion bridge](https://www.tinkercad.com/fusion) — no starting over.
- Course: [Learn Fusion 360 in 30 Days, 2026 Edition](https://productdesignonline.com/learn-autodesk-fusion-360-in-30-days-official-course/) ([Product Design Online on YouTube](https://www.youtube.com/channel/UCooViVfi0DaWk_eqxIXXiOQ)) — one everyday object per day; you need roughly days 1–10, not all 30. Dad is doing the same course, so you'll have an in-house study partner. Backup: [Autodesk's self-paced Fusion collection](https://www.autodesk.com/learn/ondemand/collection/self-paced-learning-for-fusion).
- City projects here: dimensioned interlocking baseplate system, parametric building generator, all capstone buildings, CADmapper-export edits.
- If Fusion fights your computer: [Onshape](https://www.onshape.com/en/pricing) runs in any browser (free-plan docs are public) with an excellent free [Learning Center](https://learn.onshape.com/). Pick one, not both.

---

## Urban planning brain food 🧠
...
1. **Redesign-your-neighborhood.** Pull our block from [Map2Model](https://www.map2model.de/) or [CADmapper](https://cadmapper.com/), print it as-is, then design drop-in replacement blocks: a new park, a denser corner, a protected bus lane. Present both versions Sunday.
2. **Plan-a-transit-line.** Lay out a bus route through your printed city with the [Modular City Road Network](https://makerworld.com/en/models/1368003-modular-city-road-network): every home tile within 2 tiles of a stop, no stop pair closer than 3 tiles. Defend the route at family design review.
3. **The re-zoning hearing.** Set up a grid with the [Planning Kit](https://www.printables.com/model/1625475-modular-mini-city-planning-kit); Dad and Matt each get one complaint ("too far from a shop," "hospital too close to my house"). Fix the layout by moving pieces only — then explain the trade-offs you made.
4. **Density derby.** Same population, three layouts: all houses, all towers, and a mixed medium-density version. Measure footprints, then argue which one you'd actually want to live in — and why the answer isn't automatically "towers."
5. **City-builder game (bonus).** Turn the [miniCITIES](https://makerworld.com/en/models/1264186-minicities-metropolis) grid into a dice game — city grows one tile per turn, following zoning rules *you* write. Matt is your playtester.

### The NYC shelf (extra credit, any week)
[Manhattan 3D Mini v2.0](https://makerworld.com/en/models/95824-new-york-city-manhattan-3d-mini-v2-0) · [Midtown Manhattan Mini v2](https://makerworld.com/en/models/495851-new-york-city-midtown-manhattan-mini-v2) · [Midtown Manhattan — Small](https://makerworld.com/en/models/1169682-midtown-manhattan-ny-small) (built from real geospatial layouts) · [Empire State Building](https://makerworld.com/en/models/1623548-empire-state-building) (161 mm, Art Deco detail) · [City Skyline — New York by XJBHC](https://makerworld.com/en/models/994532-city-skyline-new-york) · browse the [MakerWorld CITY collection](https://makerworld.com/en/collections/17026248-city) and [Mini City Buildings collection](https://makerworld.com/en/collections/2040777).

---

## Capstone spec: an original city district

**The brief:** design, print, and present an original city district — planned by you, modeled by you, printed multi-plate and multi-color on the H2C.

### Scale decision (make it in week 6, in writing)
...
- [ ] A drawn plan first: street grid + zoning map (colors per zone) on paper or in Tinkercad, approved at family design review before printing
- [ ] At least **6 original buildings** designed by you (≥3 in Fusion 360), covering ≥3 typologies (residential / commercial / civic / landmark)
- [ ] **Modular baseplates** with connectors or embedded magnets (pause-at-height — get Dad), so the district assembles and survives transport
- [ ] **Multi-plate:** minimum 3 plates, planned print order, each plate logged in [07-build-log-template.md](07-build-log-template.md)
- [ ] **Multi-color with intent:** colors mean something (zoning colors, ground-vs-building, transit-line color) — not just decoration
- [ ] **One real-data element:** terrain base, real street pattern, or a real building footprint from the toolbox above
- [ ] **One transit element:** a bus/rail line with stops, placed by a rule you can state
- [ ] A name, and a half-page "planning story": who lives here, how they get around, what problem the district solves
- [ ] Purge/waste tracked for the multicolor plates (week 4 science pays off here)

### Showcase criteria (week 8 family design review)

1. **Vision** — can you pitch the district in 60 seconds, and does the model match the pitch?
2. **Planning logic** — point to one zoning decision, one density decision, one transit decision, and defend each.
3. **Craft** — clean prints, tiles that actually mate, deliberate color.
4. **Original vs. borrowed** — clearly credit any system you built on (GreebleCity footprint, road network) vs. what's 100% yours.
5. **The v2 answer** — every real designer knows what they'd change. What's yours?

Best-of goes to MakerWorld via Dad's account — publishing details in [04-contests-and-community.md](04-contests-and-community.md). Ideas overflow? Raid [05-idea-bank.md](05-idea-bank.md). Print failures? [08-troubleshooting.md](08-troubleshooting.md) before you panic.
