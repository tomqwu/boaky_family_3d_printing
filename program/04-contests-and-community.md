...
- **Photos required, preferably of the actual printed model.** Renders alone are weaker. Plan a photo session for every entry.
- Must be **printable on an FDM printer** (our H2C qualifies easily).
...
- MakerWorld accounts require **age 13+**; users 13–17 need a **legal guardian to review and accept the Terms** on their behalf.
- The monetized programs — [Exclusive Model Program](https://makerworld.com/en/exclusive-model-policy) and [Commercial Membership](https://makerworld.com/en/commercial-license-membership-agreement), plus Crowdfunding — require **18+** (age of majority).
...
- **Peter (13) may have his own browsing account** with Dad's guardian consent — for following creators, saving models, and rating profiles. He does not publish from it.
...
3. **Presentation** — good photos, **verified print profiles**, clear assembly instructions, engagement.
...
|---|---|---|
| A Boost from another user | **12 points** to the creator (15 for Exclusive models) | [VERIFIED — Bambu blog + All3DP] |
...
| Maker's Supply Creator Incentive | 3–15% cash commission when your model has a Bill of Materials and buyers use the BOM links | [VERIFIED] |
...
- **350 Prusameters = a free Prusament spool** (PLA/PETG/ASA) — a more kid-tangible target than the gift card.
...
- [ ] **Correct Original vs Remix labeling.** Remixes must credit the original and describe what changed; minor tweaks (scaling, recoloring, adding a name) are not valid remixes and get taken down.
...
- **Aggregators:** [3DWithUs competitions list](https://3dwithus.com/3d-printing-competitions) tracks MakerWorld/Printables/Cults contests in one place; [Cults3D contests](https://cults3d.com/en/contests) run regularly too.
