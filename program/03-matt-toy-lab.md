...
**This is YOUR track, Matt: 8 weeks to go from printing awesome toys to designing your own — ending with a tabletop soccer game you build yourself.**
...
Right now you can pick a cool model and print it. By the end of August you'll be able to do something way better: **invent a toy that doesn't exist yet and make it real.**
...
### Week 1 (Jul 6–12): Bootcamp — first prints, first design
...
### Week 2 (Jul 13–19): Remix week — flexi toys, taken apart (with your eyes)
...
**Stretch:** study the pros — [Flexi Factory (Dan Sopala) on Cults3D](https://cults3d.com/en/users/FlexiFactory) invented half this genre; the [McGybeer Cute Mini Octopus](https://www.thingiverse.com/thing:3495390) started the flexi-animal craze. Read the comparison at [3DWithUs — Best Articulated Dragons](https://3dwithus.com/articulated-dragon-models-flexible-print-in-place-for-3d-printing).

### Week 3 (Jul 20–26): Original design I — your first real toy design

**Goal:** design a moving toy from scratch in Tinkercad. Not a downloaded one. Yours.
...
### Week 4 (Jul 27–Aug 2): Multi-color mastery + 🍬 CONTEST WEEK

**Goal:** learn color painting and dual-nozzle tricks in Bambu Studio, and enter the **MakerWorld BONBON Capsules contest #150** (closes ~Aug 1 — details in [contests & community](04-contests-and-community.md)). Your entry: an original capsule-sized toy — a mini flexi creature or micro-fidget that fits inside a capsule. Small print = you can iterate 3–4 versions in one week.
...
- [Fuzzy Ball – TPU (super bouncy)](https://makerworld.com/en/models/1602395-fuzzy-ball-tpu-super-bouncy) — genuinely bouncy mesh ball.
...
**Goal:** graduate from Toy Mechanisms School (the whole [section below](#toy-mechanisms-school) is your syllabus). Print a mechanism, understand it, design your own version.
...
### Week 7 (Aug 17–23): Capstone build — tabletop soccer ⚽

**Goal:** build the tabletop soccer game. Full spec in the [capstone section](#capstone-the-boaky-cup-tabletop-soccer-game) below. This is a multi-plate, multi-day build — plan plates with Dad on Saturday, run big prints between sessions.

**Projects:** the game itself, plus your custom-designed players.

**Skills:** multi-plate project management, assembly, testing and fixing ("the goal keeps tipping over" is a design problem YOU get to solve).

**Stretch:** custom team crest color-painted on the pitch or goals.

### Week 8 (Aug 24–30): Finish + Showcase 🏆

**Goal:** finish the game, run the **Boaky Cup family tournament** on showcase day, publish your best original designs to MakerWorld from Dad's account (see [publishing guide](04-contests-and-community.md)).

**Projects:** final assembly, spare parts (print 2 extra balls and 2 extra players — tournament insurance), trophy for the tournament winner (World Cup print ideas: [3DSPRO World Cup 2026 roundup](https://3dspro.com/resources/blog/what-to-3d-print-for-the-fifa-world-cup-2026-part-one)).

**Stretch:** finish your Lucky 13 custom character and pose it holding the trophy for the showcase photo.

---

## Toy Mechanisms School 🔧

This is what separates people who *print* toys from people who *design* them. Six mechanisms, each with: what it is, a model that proves it, and a design exercise to make your own.

| Mechanism | What it is | See it working | Your design exercise |
|---|---|---|---|
| **Print-in-place hinge** | Two parts printed already connected, with a tiny air gap so they swing free | [Flexi Pangolin](https://makerworld.com/en/models/1090887-flexi-pangolin) | Design a one-hinge "chomper" jaw in Tinkercad with 0.3 mm clearance; rules & numbers: [Snapmaker hinge guide](https://www.snapmaker.com/blog/3d-printed-hinges/) |
| **Snap-fit joint** | A flexible clip that bends, clicks in, and holds — no glue, no screws | [FLICKpitch! Table Soccer](https://makerworld.com/en/models/1970788-flickpitch-table-soccer-futbol-game) snaps together with zero tools | Design a small box with a snap-on lid; how-to: [Hubs snap-fit design guide](https://www.hubs.com/knowledge-base/how-design-snap-fit-joints-3d-printing/) |
| **Ball joint** | A ball that clicks into a socket and rotates every direction — action-figure shoulders | [LUCKY 13 jointed figure](https://www.printables.com/model/148367-lucky-13-printable-jointed-figure) | Design one ball + C-shaped socket pair. Secret from the [Shapeways ball-joint guide](https://www.shapeways.com/blog/how-to-design-snap-fit-ball-joints-for-3d-printing-with-shapeways): make ball and socket the SAME diameter and leave the socket open like a C so it snaps in |
| **Spinner / gyro bearing** | Rings inside rings that spin freely — printed in one piece | [Gyroscope Fidget Spinner by TechJeeper](https://makerworld.com/en/models/60026-gyroscope-fidget-spinner), [Hexagon Gyro PiP](https://makerworld.com/en/models/823168-hexagon-gyro-fidget-spinner-print-in-place) | Design a 2-ring gyro in Tinkercad — the challenge is the gap between rings (start at 0.4 mm) |
| **Flexi segments** | Lots of small hinges in a row = a body that flops and curls | [Articulated Nautilus](https://makerworld.com/en/models/2274795-articulated-nautilus-flexi-print) | Your Week 3 creature IS this exercise — the [articulated fish tutorial](https://www.youtube.com/watch?v=lCcYfagc1eQ) shows the method |
| **Rubber-band / wind-up power** | Stretch or wind a band to store energy, release it to GO | [Rubber Band Car by Bill Lab](https://makerworld.com/en/models/1642220-rubber-band-car), [Auto Folding Car PiP](https://makerworld.com/en/models/50794-auto-folding-car-print-in-place) (prints flat, folds itself!) | Design a rubber-band launcher for your TPU bouncy ball — axle, hook, band, fire |
...
- [Super Mario Question Block for Nintendo Switch](https://makerworld.com/en/models/229811-super-mario-question-block-for-nintendo-switch) — holds your game cartridges. Functional!
- [Super Mario Goomba](https://makerworld.com/en/models/155064-super-mario-goomba), [Piranha Plant multi-part by NeneBG](https://makerworld.com/en/models/1068967-piranha-plant-mario-bros), more via the [Super Mario Bros. collection](https://makerworld.com/en/collections/2397185-super-mario-bros) and [Printables MARIO tag](https://www.printables.com/tag/mario).
...
## TPU week: printing squishy 🏀

TPU is flexible filament — prints come out rubbery, bendy, bouncy. And your printer is genuinely special at it: the H2C can run **soft TPU in one nozzle and hard PLA in the other, in the same print**. Rubber tires on a rigid car. Grippy soles on an action figure. Most printers on Earth can't do this.
...
**The TPU project menu (all verified):**

| Project | Why it's awesome |
|---|---|
| [Airless Soccer Ball by 3DXAV](https://makerworld.com/en/models/208034-soccer-football-airless-ball) | THE flagship — hex/pentagon panels with stitching detail, tested with Bambu TPU 95A HF |
| [Airless Football](https://makerworld.com/en/models/1677467-airless-football-soccer) | Double-hex lattice; 90A = soft, 95A = firm — print the science experiment |
| [PRINT IN PLACE Airless Soccer Ball](https://makerworld.com/en/models/393988-print-in-place-airless-soccer-ball) | Another take on the lattice ball |
| [Fuzzy Ball – super bouncy](https://makerworld.com/en/models/1602395-fuzzy-ball-tpu-super-bouncy) | Organic mesh, genuinely bouncy |
| [Bouncy Ball Flex TPU by Cherry Hill Tech](https://www.printables.com/model/83882-bouncy-ball-flex-tpu) | 25 mm, two halves, 20% infill — quick win |
| [Articulated Octopus – TPU version](https://makerworld.com/en/models/1316116-articulated-octopus-tpu-version) | Squishy concentric-infill head + flexi tentacles |
| [Squishy Morf Worm fidget](https://makerworld.com/en/models/173882-squishy-silent-morf-worm-fidget-stretch-toy) | Silent stretch fidget |
| [Articulated Flexy Octopus Keychain](https://makerworld.com/en/models/2190867-articulated-flexy-octopus-keychain-fidget-toy) | Backpack-sized flexi |

More ideas: the [Bambu forum "TPU Designs?" thread](https://forum.bambulab.com/t/tpu-designs/115020).

---

## Capstone: the Boaky Cup tabletop soccer game 🏆⚽

World Cup 2026 is happening in North America **this exact summer** — your capstone rides the wave ([3DSPRO World Cup print roundup](https://3dspro.com/resources/blog/what-to-3d-print-for-the-fifa-world-cup-2026-part-one), [3Dnatives roundup](https://www.3dnatives.com/en/3d-prints-world-cup-11062026/)).

**Pick your base game** (weekend-of-Aug-15 decision with Dad):

| Option | Style | Difficulty |
|---|---|---|
| [FLICKpitch! Table Soccer](https://makerworld.com/en/models/1970788-flickpitch-table-soccer-futbol-game) | Finger-flick soccer; snaps together, zero glue/screws/tools | ⭐⭐ Top pick |
| [Foosball – Table football](https://makerworld.com/en/models/538700-foosball-baby-foot-table-football-soccer) | Real working mini foosball table | ⭐⭐⭐⭐ Big multi-plate beast |
| [Office Mini Desk Foosball](https://makerworld.com/en/models/152653-office-mini-desk-foosball-table) or [FOOSBALL](https://makerworld.com/en/models/1526222-foosball) | Smaller foosball builds | ⭐⭐⭐ |
...
- [ ] At least **2 original Matt-designed components** (custom players, goal, scoreboard, team crest, trophy…)
- [ ] At least **1 mechanism** from Toy Mechanisms School designed in (snap-fit goal clips, hinged scoreboard flipper, spinner kick-off wheel…)
- [ ] **Multi-color plan** written before slicing: two team colors + pitch green + white lines; color-painted crest/logo; per-object filament assignments mapped to AMS slots
- [ ] **TPU element** — game ball printed in TPU (mini version of the airless ball), or grippy TPU feet so the pitch doesn't slide
- [ ] **Plate plan** with Dad: what prints on which plate, in what order, which run overnight (Dad approves every overnight print)
- [ ] Spares: 2 extra balls + 2 extra players before showcase day
- [ ] Build log updated as you go ([template](07-build-log-template.md))

**Showcase day scoring (Sunday Aug 30 — the family judges):**

| Criteria | Points |
|---|---|
| It works — a full match gets played, no mid-game repairs | /10 |
| Original design — your parts, your team, your ideas visible | /10 |
| Mechanism engineering — moving parts you designed move well | /10 |
| Multi-color execution — clean colors, sharp lines, no bleed | /10 |
| Presentation — name your game, explain 3 design decisions you made | /10 |

50 points possible. Then the Boaky Cup kicks off. Winner gets the printed trophy. Loser prints next week's snacks tray. 😎

---

*Stuck on anything? Ask Claude — [how-to guide](../qa/HOW-TO-ASK-CLAUDE.md). Filament to order is on the [shopping list](06-shopping-list.md). Prints failing? [Troubleshooting](08-troubleshooting.md).*
